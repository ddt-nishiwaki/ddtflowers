 ...
 * 作成日:2018.04.15
 */
public class SaveJSONRecord implements ApplicationService{
     ...
     * 作成日:2018.04.15
     */
    public SaveJSONRecord(HttpRequestController controller) {
    ...
    public void doProcedure(){
        ...
        try {
            ...
            ProcedureBase procedureSet = new ProcedureSet(mController);
            // 上記機能を実行する
