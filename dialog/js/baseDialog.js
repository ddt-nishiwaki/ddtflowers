...
/**
 * クラス名:baseDialog 概要 :ダイアログ内コンテンツ作成、要素操作のためのクラスのための基底クラス 引数 :Element
 * dialog:コンテンツを作る対象となるダイアログのDOM。jQueryオブジェクトとして渡す 設計者:H.Kaneko 作成日:2015.0813
 * 作成者:T.Masuda
 */
function baseDialog(dialog){
	...
	/*
	 * 関数名:dispContents 概要 :openDialogから呼ばれる、画面パーツ設定用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0813 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:constructionContent 概要
	 * :JSONやHTMLをcreateLittleContentsクラスインスタンスにロードする。 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:getJson 概要 :JSONを取得する(オーバーライドして内容を定義してください) 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:getDom 概要 :createTag用テンプレートHTMLを取得する(オーバーライドして内容を定義してください) 引数 :なし
	 * 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0822 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:customizeJson 概要 :constructionContentで取得したJSONの加工を行う。オーバーライドして定義されたし
	 * 引数 :なし 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:dispContentsHeader 概要 :openDialogから呼ばれる、画面パーツ設定用関数のヘッダー部分作成担当関数 引数
	 * :なし 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0814 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:dispContentsMain 概要 :openDialogから呼ばれる、画面パーツ設定用関数のメイン部分作成担当関数 引数 :なし
	 * 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0814 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:dispContentsFooter 概要 :openDialogから呼ばれる、画面パーツ設定用関数のフッター部分作成担当関数 引数
	 * :なし 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0814 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setCallback 概要 :ダイアログのイベントのコールバック関数を設定する 引数 :なし(オーバーライド時に定義する) 返却値:なし
	 * 作成日 :2015.0822 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setConfig 概要 :ダイアログの設定を行う。任意でオーバーライドして定義する 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成者 :T.Masuda 作成日 :2015.0822
	 */
	...
	/*
	 * 関数名:setDialogOption 概要 :ダイアログのオプションを設定する 引数 :String optionName:オプション名 :?
	 * value:オプションに設定する値 返却値:なし 作成日 :2015.0813 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setDialogButtons 概要 :ダイアログにjQuery UI Dialogのボタンを配置する 引数 :Array
	 * buttons:ボタンの設定の配列 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0813 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setDialogTitle 概要 :タイトルをセットする 引数 :String title:タイトルの文字列 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0813 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setDialogPosition 概要 :ダイアログの位置をセットする 引数 :Object
	 * positionObj:位置設定の3つのキーが入ったオブジェクト 返却値:なし 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:updateJson 概要 :サーバへクエリを投げる前に、送信するJSONデータを加工する 引数 :なし(オーバーライド時に編集する)
	 * 返却値:なし 設計者 :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:sendQuery 概要 :DBヘテーブル操作のクエリを投げる 引数 :String
	 * sendUrl:DBへアクセスするアプリケーションのパス :Object sendObj:URLへ送信するデータのオブジェクト
	 * 返却値:Object:DBから取得したデータをオブジェクトで返す 設計者 :H.Kaneko 作成日 :2015.0815 作成者
	 * :T.Masuda
	 */
					...
					},
					{
						...
						// 閉じるボタンのコールバック関数をセットする
                  		 click:
                  			 ...
                  			 function(){
                  			 // 更新ボタンの処理を行う
                  			 // 2016/09/07 mod k.urabe
								// 閉じるボタンの名称をキャンセルボタンに統一したことによる呼び出し関数の変更
	...
	/*
	 * 関数名:callbackYes 概要 :ダイアログのはいボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackNo 概要 :ダイアログのいいえボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackCancel 概要 :ダイアログのキャンセルボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0815 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackCreateNew 概要 :新規作成ボタンのコールバック関数(必ずオーバーライドで内容を定義されたし) 引数 :なし
	 * 返却値:なし 作成日 :2015.0822 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackEdit 概要 :編集ボタンのコールバック関数(必ずオーバーライドで内容を定義されたし) 引数 :なし 返却値:なし
	 * 作成日 :2016.0409 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackCreateNew 概要 :削除ボタンのコールバック関数(必ずオーバーライドで内容を定義されたし) 引数 :なし
	 * 返却値:なし 作成日 :2016.0409 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setCallbackRowClick 概要 :テーブルの行をクリックした時のイベントのコールバック関数を設定する 引数 :なし
	 * 返却値:なし 作成日 :015.08.22 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackRowClick 概要 :テーブルの行をクリックした時のイベントのコールバック関数(内容はオーバーライドして定義されたし)
	 * 引数 :なし 返却値:なし 作成日 :015.08.22 作成者 :T.Masuda
	 */
	this.callbackRowClick = function() {
	};
	
	/*
	 * 関数名:callbackLogin 概要 :ダイアログのログインボタンを押したときのコールバック関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :015.08.23 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackCreateNew 概要 :ダイアログの新規作成ボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし
	 * 設計者 :H.Kaneko 作成日 :015.08.22 作成者 :T.Masuda
	 */
	this.callbackCreateNew = function(){
	};
	
	/*
	 * 関数名:callbackConfirm 概要 :ダイアログの確認ボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :015.08.22 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackConfirm 概要 :ダイアログの確認ボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2016.04.17 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackCloseButton 概要 :ダイアログの閉じるボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし
	 * 設計者 :H.Kaneko 作成日 :015.08.22 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackCancelButton 概要 :ダイアログのキャンセルボタンを押したときのコールバック関数用関数 引数 :なし
	 * 返却値:なし 設計者 :H.Kaneko 作成日 :015.08.22 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackReset 概要 :ダイアログのリセットボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :015.08.22 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:callbackUpdate 概要 :ダイアログの更新ボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0823 作成者 :T.Masuda
	 */
	this.callbackUpdate = function(){
	};

	/*
	 * 関数名:callbackStudents 概要 :ダイアログの受講者一覧ボタンを押したときのコールバック関数用関数 引数 :なし 返却値:なし
	 * 設計者 :H.Kaneko 作成日 :2015.0823 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:setArgumentObj 概要 :ダイアログに渡すオブジェクトを生成する。暫定的に安全性を考えてreturnするようにしました。 引数
	 * :なし 返却値:なし 作成日 :015.08.14 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:openDialog 概要 :渡されたURLから新たなダイアログを開く 引数 :String url:ダイアログのURL :Object
	 * argumentObj:ダイアログのインプットデータ、設定データのオブジェクト 返却値:なし 設計者 :H.Kaneko 作成日
	 * :2015.0814 作成者 :T.Masuda
	 */
	...
	/*
	 * 関数名:insertFooterContents 概要 :フッターのコンテンツを作る 引数 :なし(オーバーライド時に定義する) 返却値:なし
	 * 作成日 :2015.0815 作成者 :T.Masuda
	 */
	this.insertFooterContents = function(){
	}
	
	/*
	 * 関数名:callbackClose 概要 :デフォルトのcloseイベントコールバック用関数 引数 :なし 返却値:なし 設計者
	 * :H.Kaneko 作成日 :2015.0823 作成者 :T.Masuda
	 */
...
/*
 * クラス名:connectErrorException 概要 :Ajax通信失敗時の例外クラス 引数 :Object xhr:通信結果をまとめたオブジェクト
 * :int status:通信ステータスの値 :String error:エラーテキスト 作成日 :2015.0815 作成者 :T.Masuda
 */
...
/*
 * クラス名:connectErrorException 概要 :Ajax通信失敗時の例外クラス 引数 :Object
 * json:サーバから返ってきたJSONのオブジェクト :int status:通信ステータスの値 作成日 :2015.0815 作成者 :T.Masuda
 */
...
/*
 * クラス名:jsonFailedToParseException 概要 :JSONパース失敗時の例外 引数 :Object
 * json:サーバから返ってきたJSONのオブジェクト :int status:通信ステータスの値 作成日 :2015.0815 作成者 :T.Masuda
 */
...
/*
 * クラス名:failedToDisplayException 概要 :dispContents内で起きたエラーに対する例外 引数 :Object
 * json:サーバから返ってきたJSONのオブジェクト :int status:通信ステータスの値 作成日 :2015.0815 作成者 :T.Masuda
 */
...
/*
 * クラス名:cannotGetAnyRecordException 概要 :目的のレコードが取得できなかった時に投げる例外 引数 :なし 作成日
 * :2015.0815 作成者 :T.Masuda
 */
